...
```{r map1, message = FALSE, warning = FALSE, dpi = 72, fig.width = 7, fig.height = 7, fig.align = "center"}
...
```{r map2, message = FALSE, warning = FALSE, dpi = 72, fig.width = 7, fig.height = 7, fig.align = "center"}
