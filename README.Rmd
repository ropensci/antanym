...
Start by reading in the names data:
...
nms <- g %>% an_near(c(100,-66),20) %>% an_filter(feature_type="Island")
...
library(mapview)
mapshot(m %>% setView(0, -50, zoom = 2), file = "README-leaflet.png")
```
...
```{r echo=FALSE,eval=FALSE}
library(mapview)
mapshot(mps, file = "README-leafletps.png")
```
